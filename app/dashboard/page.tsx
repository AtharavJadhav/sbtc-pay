    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
        ...
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-8">
          ...
          <div className="text-gray-600">Monthly spending: ₿ 0.0024</div>
        </div>

        {/* Upcoming Payments */}
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-8">
          <h2 className="text-2xl font-bold text-black mb-4">Upcoming Payments</h2>
          <div className="text-4xl font-bold text-orange-400 mb-4">₿ 0.0004</div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-8">
          ...
          <div className="text-4xl font-bold text-indigo-600 mb-4">₿ 0.0032</div>
