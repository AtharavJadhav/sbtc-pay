  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="flex items-center space-x-2 px-4 py-2 bg-white text-indigo-600 border-2 border-indigo-600 rounded-md hover:bg-indigo-50 transition-colors font-medium"
      >
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-64 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">
          ...
          <div className="px-4 py-2 border-b border-gray-100">
            ...
            <div className="flex items-center space-x-2">
              <Bitcoin className="w-4 h-4 text-indigo-600" />
